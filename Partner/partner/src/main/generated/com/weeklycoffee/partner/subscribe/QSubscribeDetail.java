...
public class QSubscribeDetail extends EntityPathBase<SubscribeDetail> {
    ...
    private static final long serialVersionUID = 220522941L;
    ...
    public final com.weeklycoffee.partner.product.QProduct product;

    public final StringPath productImageId = createString("productImageId");
    ...
    public QSubscribeDetail(Class<? extends SubscribeDetail> type, PathMetadata metadata, PathInits inits) {
        ...
        this.product = inits.isInitialized("product") ? new com.weeklycoffee.partner.product.QProduct(forProperty("product")) : null;
    }
